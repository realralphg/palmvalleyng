<template>
  <div class="slide_container border rounded bg-white shadow-lg p-4">
    <q-img src="/img/trip1.jpg" class="shadow-lg rounded" />
    <div class="details_container my-4">
      <p class="font-semibold text-lg">Alphabet Visitation</p>
      <p>
        Nigerian army farms and ranches visited Alphavet which is a leading
        vetinerary pharmaceuticals manufacturing company.
      </p>
